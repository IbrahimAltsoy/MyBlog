...
namespace Blog.Service.Services.Concrete
{
    ...
    {
        private readonly IUnitOfWorked unitOfWork;
        ...
        public UserService(IUnitOfWorked unitOfWork, IImageHelper imageHelper, IHttpContextAccessor httpContextAccessor, IMapper mapper, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<AppRole> roleManager)
        {
