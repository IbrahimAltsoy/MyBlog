namespace Blog.Web.ToastrMessaje
{
    public static class ToastrMessage
    {
        ...
        {
            public static string UserAddSuccesfull(string user)
            {
                return $"{user} kullanıcı başarıyla eklendi.";
            }
            public static string UserUpdateSuccesfull(string user)
            {
                return $"{user} başarıyla güncellendi.";
            }
            public static string UserAddUnSuccessful(string user)
            {
                return $"{user} kullanıcı eklenemedi!!!.";
            }
            public static string UserUpdateUnSuccessful(string user)
            {
                return $"{user} kullanıcısı başarıyla güncellenemedi!!!";
            }
            public static string UserDeleteSuccessful(string user)
            {
                return $"{user} kullanıcı başarıyla silindi!!!";
            }
        }
    }
}
